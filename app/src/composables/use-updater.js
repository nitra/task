...
export function useUpdater() {
  // У dev версія в tauri.conf.json завжди 0.1.0 (реальну CI підставляє з
  // тега лише в релізній збірці), тож апдейтер вважав би свіжий код
  // застарілим і пропонував би «оновитись» до опублікованого релізу.
