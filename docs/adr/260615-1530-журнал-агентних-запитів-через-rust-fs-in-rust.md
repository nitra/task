...
## Decision Outcome
Chosen option: "тристанний `classify(actor, tool) → allow | approval | deny`", because тільки три стани дозволяють агенту *запропонувати* деструктивну дію (видиму в маніфесті), але не *виконати* її самостійно.
