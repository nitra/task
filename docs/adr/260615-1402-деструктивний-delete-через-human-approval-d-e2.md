...
Chosen option: "classify з трьома станами", because agents можуть _ініціювати_ деструктивну дію (вона зʼявляється в їхньому prompt), але виконання паузується до людського апруву; це дозволяє більш прозоро інформувати агента про намір при збереженні захисту.
